; quiny101.asm - 101 byte Quinindrome
...
_start:
    ...
    mov     dl, 101             ; [37] edx = Total Size (101)
    mov     al, 4               ; [39] eax = 4 (sys_write)
    int     0x80                ; [40] syscall: write(1, 0x10000000, 101)
...
_payload:
    dec     ebx                 ; [46] ebx = 0 (status)
    mov     al, 1               ; [47] eax = 1 (sys_exit)
    int     0x80                ; [49] syscall: exit(0)
